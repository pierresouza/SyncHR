...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      setError('Erro no login do Google: ' + err.message);
      setLoading(false);
    }
  };
            ...
            {mode === 'login' ? (
              <>
                ...
                <div className="relative flex py-2 items-center">
                  ...
                  <span className="flex-shrink mx-4 text-[10px] text-slate-500 font-mono uppercase">Ou acesse com</span>
                  <div className="flex-grow border-t border-slate-900"></div>
                </div>
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full bg-slate-900 border border-slate-800 hover:bg-slate-850 text-slate-100 text-sm font-semibold py-2.5 rounded-xl transition-all flex items-center justify-center gap-2"
                >
