...
function FeedbackFormContent() {
  ...
  let displayScript = cleanScriptText(meeting?.scriptText || '');
      ...
      <div className="w-full max-w-[700px] space-y-6 relative z-10">
        ...
        {activeStep === 2 && (
          <div className="glass-card p-6 rounded-2xl border border-slate-800 bg-slate-950/40 space-y-5 animate-fade-in">
            ...
            <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-850 text-xs text-slate-300 leading-relaxed font-sans">
